Public Class Form1
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            If IsValidData() Then
                Dim Fname As String = Convert.ToString(txtFname.Text)
                Dim Lname As String = Convert.ToString(txtLname.Text)
                Dim User As String = Convert.ToString(txtUname.Text)
    ...
    Private Function IsValidData() As Boolean
        Return _
        IsPresent(txtFname, "First Name") AndAlso
        IsPresent(txtLname, "Last Name") AndAlso
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Const Name As String = "NURAWLIYA NASUHA BT AHMAD ZUBIR (10DDT20F1051) DDT5A"
    ...
    Private Sub txtIC_TextChanged(sender As Object, e As EventArgs) Handles txtIC.TextChanged
        If txtIC.TextLength > 12 Then
            MessageBox.Show("you must inserted 12 digit only")
        End If
    End Sub
